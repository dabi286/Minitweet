...
const whoToFollow = [
  { name: "jzlendrga", username: "jzlendrga@gmail.com", avatar: "/src/assets/users/jzlendrga.jpg" },
  { name: "davevisual", username: "davey@gmail.com", avatar: "/src/assets/users/dave.jpg" },
  { name: "Celina", username: "prettyceline@gmail.com", avatar: "/src/assets/users/celine.jpg" },
];
