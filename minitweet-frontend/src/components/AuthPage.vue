...
<!-- LOGIN FORM -->
<div
  class="absolute left-0 top-0 w-1/2 h-full flex flex-col justify-center items-center px-12 bg-white 
    ...
    <form @submit.prevent="handleLogin" class="space-y-6">
      <div>
        <input
          ...
          class="w-full border-b border-gray-300 py-2 text-gray-800 placeholder-gray-400 
...
<!-- REGISTER FORM -->
<div class="absolute right-0 top-0 w-1/2 h-full flex flex-col justify-center items-center px-12 bg-white transition-all duration-700 ease-in-out z-20"
    :class="isSignUp
        ? 'translate-x-0 opacity-100 scale-100 pointer-events-auto'
    ...
    <form @submit.prevent="handleRegister" class="space-y-6">
      <div class="flex gap-6">
        <input
          ...
          class="w-1/2 border-b border-gray-300 py-2 text-gray-800 placeholder-gray-400 
          focus:outline-none focus:border-blue-600 text-[15px]"
        />
        <input
          type="text"
      ...
      <p v-if="registerError" class="text-red-500 text-sm mt-2 text-center">
        {{ registerError }}
            ...
            <!-- SLIDING PANEL -->
            <div class="absolute top-0 left-1/2 w-1/2 h-full bg-gradient-to-r from-purple-600 to-blue-600 text-white flex flex-col justify-center items-center text-center px-10 transition-transform duration-700 ease-in-out z-10"
...
const handleRegister = async () => {
    try {
        ...
        const response = await axios.post("http://localhost:8000/api/register", {
            ...
            surname: registerLastname.value, // ✅ rename this key
